-- Seed data for Florida Sound Quality scoreboard demos
-- Safe to re-run: uses fixed UUIDs with INSERT IGNORE
...
(
    '11111111-1111-4111-8111-111111111111', '2026-03-15', 'Tampa Bay Showdown', 'Alex Rivera',
...
(
    '22222222-2222-4222-8222-222222222222', '2026-03-15', 'Tampa Bay Showdown', 'Alex Rivera',
...
(
    '33333333-3333-4333-8333-333333333333', '2026-03-15', 'Tampa Bay Showdown', 'Alex Rivera',
...
(
    '44444444-4444-4444-8444-444444444444', '2026-03-15', 'Tampa Bay Showdown', 'Sam Ortiz',
...
(
    '55555555-5555-4555-8555-555555555555', '2026-04-02', 'Orlando Spring Meet', 'Alex Rivera',
...
(
    '66666666-6666-4666-8666-666666666666', '2026-04-02', 'Orlando Spring Meet', 'Sam Ortiz',
